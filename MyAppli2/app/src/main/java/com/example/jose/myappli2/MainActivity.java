package com.example.jose.myappli2;
...
import com.example.jose.myappli2.ItemMenu.ItemMenuStructure;
          ...
          public void onSuccess(int statusCode, Header[]Headers, JSONObject response) {
              try {
                  ...
                  for(int i = 0 ; i<listData.length();i++){
                      ...
                      String uriimg = obj.getString("avatar");
                      String id = obj.getString("_id");
                      int cantidad = obj.getInt("quantity");

                      ItemMenuStructure item = new ItemMenuStructure(name,uriimg,cantidad,id );
                  }
              }
